Dayhomes::Application.configure do
  ...
  config.assets.precompile += %w(jquery.home_slider.js upgrade.js upgrade_init.js billing.js billing_init.js organization.js categories.css mailer.css pages.css landingpage.css landingpage.js)
